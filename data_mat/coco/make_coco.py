...
# 处理成ndarray的字典，保存
scio.savemat(os.path.join(root_dir, "index.mat"), {'index': img}, do_compression=True)  # ndarray: (20015,)
scio.savemat(os.path.join(root_dir, "caption.mat"), {'caption': txt}, do_compression=True)  # ndarray: (20015,)
# ndarray: (20015, 1386)
scio.savemat(os.path.join(root_dir, "caption_one_hot.mat"), {'caption_one_hot': txt_one_hot}, do_compression=True)

scio.savemat(os.path.join(root_dir, "label.mat"), {'label': lab}, do_compression=True)  # ndarray: (20015, 24)
print("Save all *.mat")
