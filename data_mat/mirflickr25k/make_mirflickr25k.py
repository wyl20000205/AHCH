...
root_dir = "."
print("--------------------------------------------------------------------")
scio.savemat(os.path.join(root_dir, "index.mat"), {'index': img_abs_paths}, do_compression=True)
scio.savemat(os.path.join(root_dir, "caption.mat"), {'caption': tags_strs}, do_compression=True)
scio.savemat(os.path.join(root_dir, "caption_one_hot.mat"), {'caption_one_hot': tags_one_hot}, do_compression=True)
scio.savemat(os.path.join(root_dir, "label.mat"), {'label': labels}, do_compression=True)
print("Save all *.mat")
